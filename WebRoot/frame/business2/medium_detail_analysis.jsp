...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption" style="height: 20px;">
			<i class="icon-reorder"></i>媒介明细-><span id="mediumName"></span>
		</div>
		<div class="tools">
...
function downExcelFile(){
	...
	rtpparams.medium_id = mediumId;
	rtpparams.start_index = 0;
	rtpparams.end_index = 100
	RptManager.genReportFile(rtpparams,'medium2.rptdisger',{
...
function querygirdPartPage(currentPage){
	...
	//通过ajax查询后台数据
	RptManager.genReportDataToHtmlAndCount(rtpparams,'medium2.rptdisger', function(content){
...
$(document).ready(function() {
	if('${sessionScope.userInfo.mediumId}'!='-1'){
		$('#mediumName').html('${sessionScope.userInfo.name}');
		mediumId='${sessionScope.userInfo.mediumId}';
	}
	if('${param.mediumName}'!=''){
		$('#mediumName').html('${param.mediumName}');
	}
	if('${param.mediumId}'!=''){
