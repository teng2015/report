...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption" style="height: 20px;">
			<i class="icon-reorder"></i>渠道明细-><span id="channelName"></span>
		</div>
		<div class="tools">
...
function downExcelFile(){
	...
	RptManager.genReportFile(rtpparams,'channel2.rptdisger',{
...
function querygirdPartPage(currentPage){
	...
	//通过ajax查询后台数据
	RptManager.genReportDataToHtmlAndCount(rtpparams,'channel2.rptdisger', function(content){
		parampage.count=parseInt(content[1]);
		//构造报表模板参数，并展示模板
		var param = new girdbirt01param(content[0],parampage);
		param.tdw=['150px','60px','85px','60px','85px','70px','90px','90px','70px','140px','140px'];
